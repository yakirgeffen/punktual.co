            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To preserve your work, we temporarily store event drafts in your browser's local storage for up to 24 hours. 
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    If you choose to sign in with Google, we receive basic profile information according to Google's privacy policies. 
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    (Google Calendar, Apple Calendar, Outlook, etc.). We don't track or store this interaction.
                  </p>
                </div>
              </div>
            </section>
