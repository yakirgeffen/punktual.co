                      ...
                      {selectedPlatforms.map(platform => {
                        ...
                        return (
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-emerald-500 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm"
                          ...
                          <div key={platform} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="px-3 py-1 text-xs font-medium text-white bg-emerald-500 rounded hover:bg-blue-700 transition-colors"
                                disabled={!link}
                              >
                                Open
                              </button>
                ...
                <div className="space-y-4">
                  <div className="bg-white border-2 border-dashed border-gray-200 rounded-lg p-6">
                    <div className="text-center space-y-4">
                      ...
                      <div className="pt-6">
                        <button className="px-6 py-3 bg-emerald-500 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm">
                          📅 Add to My Calendar
                        </button>
                      </div>
                    </div>
