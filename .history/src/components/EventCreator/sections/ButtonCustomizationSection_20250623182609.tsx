...
export default function ButtonCustomizationSection() {
  ...
  return (
    <div className="space-y-6 pb-4">
      ...
      {/* Button Color - Updated to use emerald as default */}
      <div>
        <label className="block text-sm font-medium text-gray-700 pb-1 mb-3">Button Color</label>
        <div className="flex items-center gap-4">
          {[
            { value: '#10b981', name: 'Emerald' }, // emerald-500 as default
          ...
          <input
            type="color"
            value={buttonData.colorScheme || '#10b981'} // emerald-500 default
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-6">
          <Checkbox
            ...
            size="md"
            color="primary" // This will use emerald now
          >
