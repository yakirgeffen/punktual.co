...
// Button Shapes
const BUTTON_SHAPES = [
  { id: 'squared', name: 'Squared', preview: 'Squared', class: 'rounded-none' },
  { id: 'rounded', name: 'Rounded', preview: 'Rounded', class: 'rounded-lg' },
  { id: 'pill', name: 'Pill', preview: 'Pill', class: 'rounded-full' }
];
          ...
          <div className="grid grid-cols-1 gap-4">
            {LAYOUT_TYPES.map((type) => (
              <div
                ...
                onClick={() => updateButton({ buttonLayout: type.id })}
              >
