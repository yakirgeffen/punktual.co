                      ...
                      {selectedPlatforms.map(platform => {
                        ...
                        return (
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-emerald-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm"
