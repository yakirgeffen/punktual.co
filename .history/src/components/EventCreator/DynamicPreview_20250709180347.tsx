// src/components/EventCreator/DynamicPreview.tsx
        ...
        <div className="p-4 flex-1 overflow-y-auto">
          {!isComplete ? (
            ...
            {useCase === 'individual-buttons' && (
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Individual Platform Buttons</h3>
                <p className="text-sm text-gray-600 mb-4">Separate button for each calendar platform</p>
