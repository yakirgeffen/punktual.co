...
//         onClose();
//         // Note: For signup, redirect happens after email confirmation
//       }
//     } catch (error) {
...
//     setLoading(true);
//     try {
//       // Store redirectTo in localStorage before OAuth redirect
//       if (redirectTo) {
          ...
          {!showEmailForm ? (
            ...
            <div className="space-y-6">
              <Button
                variant="bordered"
                size="lg"
                className="w-full h-12 border-2 hover:border-emerald-300"
                startContent={
                  loading ? <Spinner size="sm" /> : (
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div className="text-center space-y-4">
                ...
                <div className="border-t pt-4">
                  <span className="text-sm text-gray-600">
                    {isSignUp ? 'Already have an account?' : 'New to Punktual?'}{' '}
                  </span>
                  <button
                    onClick={toggleMode}
            ...
            // Email form with back navigation
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex-1 text-center">
                  ...
                  <button
                    onClick={toggleMode}
                    className="text-sm text-emerald-600 hover:text-emerald-500 mt-1 transition-colors"
                  >
