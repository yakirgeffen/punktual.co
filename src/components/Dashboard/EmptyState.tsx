  ...
  return (
    <div className="text-center py-16">
      ...
      <p className="text-slate-400 text-sm mb-8 max-w-md mx-auto">
        Just saved an event and not seeing it? Try refreshing the page. If you created a hosted event page, find it under{' '}
        <Link href="/dashboard/event-pages" className="text-emerald-600 hover:underline">
          My Event Pages
        </Link>
        .
      </p>
